      ...
      <nav>
        <div className="nav-wrapper grey darken-4">
          ...
          <ul className="right">
            ...
            >
              <a href="#!">
                <span className="hide-on-small-only left">Visualize Path</span>
            ...
            >
              <a href="#!">
                <span className="hide-on-small-only left">Reset</span>
                <i className="material-icons right hide-on-med-and-down">
                  loop
                </i>

                <i className="material-icons hide-on-med-and-up">loop</i>
              </a>
            </li>
            ...
            >
              <a href="#!">
                <span className="hide-on-small-only left">World Presets</span>
                <i className="material-icons right hide-on-med-and-down">
                  public
                </i>

                <i className="material-icons hide-on-med-and-up">public</i>
              </a>
            </li>
          </ul>
        </div>
